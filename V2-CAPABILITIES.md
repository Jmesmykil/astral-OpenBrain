...
Kernel `astral-kernel 2.2.8` · library index schema 33 · 5,269 checks passing, 0 failed,
0 skipped.
...
| **Misheard titles** | A title mangled by the microphone still finds the book — "moderate" reaches a book whose title starts with *Modern* — but a book that is not on the card is refused, never substituted. |
...
{"ok":true,"agent_id":"...","assigned":["..."],"count":1,"message":"Updated with 1 ability(s)."}
