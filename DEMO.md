...
**Run `python3 demo.py` before a demo.** It writes nothing to the card, no timer, no
...
> "3 books on the card: <the titles of the three books on that card>. There's also 2 sets
> of documentation in 66 files and 29 reference works in 57 volumes, 397,706 passages in
> all."
>
...
**To light the cloud rung before a demo** (two edits on the device, no code):
