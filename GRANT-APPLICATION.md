...
Around them is an ecosystem of applications. Q OS, a windowed desktop for the Nintendo Switch, in development and not released. Void IDE and Void CLI. Astral Workspace. The ASCII render kernel and its Unity and Blender hosts. sCAN. Two games, SlimeShot close to done and MoBA close to mechanically done. And soloDOLO, an animated series. This device is the small end of that work, and it's the first piece of it to ship through someone else's review.

Public work you can open now: https://github.com/Jmesmykil/astral-OpenBrain (this project), https://github.com/Jmesmykil/openhome-cli, https://github.com/Jmesmykil/abilities, https://github.com/Jmesmykil/QNX (Q OS, in development). The rest is private and available on request.
